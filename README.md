...
Use the following demo admin credentials to sign in (if available on your deployment):

- **Email:** `pgupta49@gmail.com`
- **Password:** `123456789@Lms`
  
## User Login Credentials

Use the following demo user credentials to sign in (if available on your deployment):
...
```bash
git clone https://github.com/Princegupta101/Learning-Management-System.git
```
